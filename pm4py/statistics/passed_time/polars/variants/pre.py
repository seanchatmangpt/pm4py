...
def apply(
    ...
    # Basic DFG computation for preceding activities
    ...
    if sum_acti_pre > 0:
        sum_perf_pre = sum_perf_pre / sum_acti_pre

    return {"pre": pre, "pre_avg_perf": sum_perf_pre, "pre_total_acti": sum_acti_pre}