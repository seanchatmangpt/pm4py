    ...
    def __deepcopy__(self, memodict={}):
        ...
        for place in self:
            ...
            new_place = (
                ...
                else PetriNet.Place(place.name, properties=place.properties)
            )
...
class PetriNet(object):
    ...
    def __deepcopy__(self, memodict={}):
        ...
        for place in self.places:
            place_copy = PetriNet.Place(
                place.name, properties=place.properties
            )
...
class InhibitorNet(PetriNet):
    ...
    class InhibitorArc(PetriNet.Arc):
        def __init__(self, source, target, weight=1, properties=None):
            PetriNet.Arc.__init__(
                self, source, target, weight=weight, properties=properties
            )
