...
RUN pip3 install contourpy==1.3.2 fonttools==4.58.4 kiwisolver==1.4.8 matplotlib==3.10.3 pillow==11.2.1 
RUN pip3 install anyio==4.9.0 asttokens==3.0.0 attrs==25.3.0 backcall==0.2.0 certifi==2025.6.15 charset-normalizer==3.4.2 convertdate==2.4.0 decorator==5.2.1 distro==1.9.0 executing==2.2.0 h11==0.16.0 httpcore==1.0.9 httpx==0.28.1 idna==3.10 ipython==9.3.0 jedi==0.19.2 Jinja2==3.1.6 jsonpickle==4.1.1 lunardate==0.2.2 MarkupSafe==3.0.2 matplotlib-inline==0.1.7 parso==0.8.4 pickleshare==0.7.5 prompt-toolkit==3.0.51 pure-eval==0.2.3 pydantic==2.11.7 Pygments==2.19.2 pyluach==2.2.0 PyMeeus==0.5.12 pyrsistent==0.20.0 sniffio==1.3.1 stack-data==0.6.3 traitlets==5.14.3 typing_extensions==4.14.0 urllib3==2.5.0 wcwidth==0.2.13 
